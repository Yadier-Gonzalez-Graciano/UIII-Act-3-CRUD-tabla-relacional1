            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">FECHA PRODUCTO</th>
                        <th scope="col">PRODUCTOS ALM</th>
                ...
                <tbody>
                    ...
                    INNER JOIN provedores ON productos.categoriaId = provedores.idCategoria
                    INNER JOIN sucursales ON productos.marcaId = sucursales.idMarca");
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['fechaProducto'] ?></th>
                            <th scope="row"><?php echo $resultado['almProducto'] ?></th>
                            <th scope="row">
